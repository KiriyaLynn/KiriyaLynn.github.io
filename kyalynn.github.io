...
<body>
    <div id="chat-circle">
        <div class="chef" id="chef">
            ...
            <div class="pan"></div>
            <div class="help-text">NEED HELP??</div> <!-- The text that moves -->
        </div>
    ...
    <div class="chat-box">
        <div class="chat-box-header">
            <span class="chat-box-toggle"><button class="material-icons">&times;</button></span>
...
statemachine.interact = function (option) {
    ...
    // Add the selected option's title as a message in a new message box
